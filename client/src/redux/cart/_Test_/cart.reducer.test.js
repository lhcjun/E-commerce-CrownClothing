...
describe('cartReducer', () => {
    ...
    it('should update cartItems with new array when setCartFromFirebase action fired', () => {
        const mockNewCartItems = [ { id: 1, quantity: 3 }, { id: 2, quantity: 1 } ];
        const mockPrevState = {
            hidden: true,
